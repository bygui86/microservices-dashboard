...
public class InMemoryForwardOAuth2TokenWireMock {

	private final static int HTTP_PORT = 7078;
	private final static int HTTPS_HTTP_PORT = 7077;
	private final static int HTTPS_PORT = 7079;
