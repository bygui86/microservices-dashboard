 ...
 */
public interface StrategyBeanProvider {

    String getType();

    OutboundSecurityObjectProvider getOutboundSecurityObjectProvider();

    OutboundSecurityStrategy getOutboundSecurityStrategy();
}
